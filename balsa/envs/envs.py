...
class TPCH10_assorted_small_2(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/tpch_assorted_small_2')
        return p
...
class TPCH10_assorted_small(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/tpch_assorted_small')
        return p
