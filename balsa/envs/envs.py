...
class IMDB_BAO(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/sample_queries_imdb')
        return p
...
class JoinOrderBenchmark_changed(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/job_changed')
        return p
...
class IMDB_assorted(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted')
        return p
...
class IMDB_assorted_2(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_2')
        return p
...
class IMDB_assorted_3(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_3')
        return p
...
class IMDB_assorted_3_cp1(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_3_cp1')
        return p
...
class IMDB_assorted_4(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_4')
        return p
...
class IMDB_assorted_5(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_5')
        return p
...
class IMDB_assorted_5_cp1(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_5_cp1')
        return p
...
class IMDB_assorted_5_cp2(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_5_cp2')
        return p
...
class IMDB_assorted_5_cp3(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_5_cp3')
        return p
...
class IMDB_assorted_small(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/imdb_assorted_small')
        return p
...
class TPCH10_assorted(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/tpch_assorted')
        return p
...
class TPCH10_assorted_2(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/tpch_assorted_2')
        return p
...
class IMDB_BAO_changed(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/sample_queries_imdb_changed')
        return p
...
class TPCH10(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/sample_queries_tpch')
        return p
...
class SO(Workload):
    ...
    def Params(cls):
        ...
        # Needs to be an absolute path for rllib.
        module_dir = os.path.abspath(os.path.dirname(balsa.__file__) + '/../')
        p.query_dir = os.path.join(module_dir, 'queries/sample_queries_so')
        return p
