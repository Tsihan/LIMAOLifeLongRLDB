...
FROM account AS acc, site AS s1, so_user AS u1, question AS q1, post_link AS pl, tag AS t1, tag_question AS tq1, answer AS a1
WHERE
NOT EXISTS (
    SELECT *
    FROM answer AS a1
...
q1.creation_date > '2017-01-01'::date AND
