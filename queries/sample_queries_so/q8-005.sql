...
site AS s, post_link AS pl, question AS q1, question AS q2, comment AS c1, comment AS c2,
tag AS t, tag_question AS tq1, tag_question AS tq2
WHERE
s.site_name = 'german' AND
t.name IN ('ruby-on-rails', 'javascript', 'python-3.x', 'excel') AND
