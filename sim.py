...
class Sim(object):
    ...
    def Params(cls):
        ...
        # p.Define(
        #     "workload",
        #     envs.TPCH_assorted.Params(),
        #     "Params of the Workload, i.e., a set of queries.",
        # )

        # p.Define(
        #     "workload",
        #     envs.TPCH_assorted_2.Params(),
        #     "Params of the Workload, i.e., a set of queries.",
        # )
    ...
    def _SimulationDataPath(self):
        ...
        #return "data/TPCH_assorted/sim-data-{}.pkl".format(hash_key)
        #return "data/TPCH_assorted_2/sim-data-{}.pkl".format(hash_key)        
    ...
    def _FeaturizedDataPath(self):
        ...
        #return "data/TPCH_assorted/sim-featurized-{}.pkl".format(hash_key)
        #return "data/TPCH_assorted_2/sim-featurized-{}.pkl".format(hash_key)
